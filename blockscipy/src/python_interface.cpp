...
PYBIND11_MODULE(_blocksci, m) {
    ...
    py::class_<Blockchain> blockchainCl(
        m, "Blockchain",
        "Class representing the blockchain. This class is constructed by passing it a string representing a file path "
        "to your BlockSci data files generated by blocksci_parser",
        py::dynamic_attr());
    ...
    py::class_<script::WitnessScriptHash> witnessScriptHashCl(m, "WitnessScriptHashAddress", addressCl,
                                                              "Extra data about pay to script hash address");
    py::class_<script::Multisig> multisigCl(m, "MultisigAddress", addressCl,
    ...
    py::class_<GenericRange, GenericIterator> genericRangeCl(m, "GenericRange",
                                                             "Class representing any blocksci range");
