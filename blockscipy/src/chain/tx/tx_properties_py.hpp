...
struct AddTransactionMethods {
    ...
    void operator()(FuncApplication func) {
        ...
        func(property_tag, "output_value", totalOutputValue<Transaction &>,
        ...
        func(
            ...
            "The (rounded) ratio of fee paid to size of this transaction (in byte). By default this uses virtual size, "
        ...
        func(
            ...
            "The (rounded) ratio of fee paid to size of this transaction (in kbyte). By default this uses virtual "
            "size, but passing total, base, weight, or virtual let's you choose a different size measure",
            pybind11::arg("size_measure") = "virtual");
        func(
            property_tag, "op_return",
            +[](const Transaction &tx) -> ranges::optional<Output> { return getOpReturn(tx); },
        ...
        func(
            property_tag, "is_wasabi2_coinjoin",
            +[](const Transaction &tx) -> bool { return blocksci::heuristics::isWasabi2CoinJoin(tx); },
            "Return's true if this transaction is a Wasabi CoinJoin transaction");
        func(
            property_tag, "is_ww2_cj_debug",
            +[](const Transaction &tx) -> bool {
        ...
        func(
            property_tag, "is_whirlpool_coinjoin",
            +[](const Transaction &tx) -> bool { return blocksci::heuristics::isWhirlpoolCoinJoin(tx); },
            "Return's true if this transaction is a Whirlpool CoinJoin transaction");
        func(
            property_tag, "is_ashigaru_coinjoin",
            +[](const Transaction &tx) -> bool { return blocksci::heuristics::isAshigaruCoinJoin(tx); },
            "Return's true if this transaction is a Ashigaru CoinJoin transaction");
        func(
            property_tag, "is_joinmarket_coinjoin",
            +[](const Transaction &tx) -> bool { return blocksci::heuristics::isJoinMarketCoinJoin(tx); },
            "Return's true if this transaction is a JoinMarket CoinJoin transaction");
        func(
            property_tag, "is_wasabi1_coinjoin",
            +[](const Transaction &tx) -> bool { return blocksci::heuristics::isWasabi1CoinJoin(tx); },
            "Return's true if this transaction is a WW1 CoinJoin transaction");
        func(
            method_tag, "is_wasabi2_coinjoin_with_input_count",
            +[](const Transaction &tx, uint64_t min_input_count) -> bool {
            ...
            pybind11::arg("min_input_count") = 50);
        func(
            property_tag, "mempool_space_link",
            +[](const Transaction &tx) -> std::string { return "https://mempool.space/tx/" + tx.getHash().GetHex(); },
            "A link to the mempool.space page for this transaction");
        func(
            property_tag, "coinjoin_tag",
            +[](const Transaction &tx) -> int64_t {
                if (blocksci::heuristics::isWasabi2CoinJoin(tx)) {
                    // 850237 is July 1st 2024
                    return tx.block().height() < 850237
                               ? static_cast<int64_t>(blocksci::heuristics::CoinJoinType::WW2zkSNACKs)
                               : static_cast<int64_t>(blocksci::heuristics::CoinJoinType::WW2PostzkSNACKs);
                    ...
                    return static_cast<int64_t>(blocksci::heuristics::CoinJoinType::Ashigaru);
                    ...
                    return static_cast<int64_t>(blocksci::heuristics::CoinJoinType::JoinMarket);
                } else {
